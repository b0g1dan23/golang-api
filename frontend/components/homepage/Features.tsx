            ...
            <div className="flex gap-20 max-md:flex-col">
                <div className="flex-1 flex items-center flex-col text-center ">
                    ...
                    <div className="flex flex-col gap-4.5 items-center mt-12">
                        ...
                        <p className="max-w-100 text-center">Custom your own card for your exact incomes and expenses needs.</p>
                    </div>
                </div>
                <div className="flex-1 flex items-center flex-col text-center ">
                    ...
                    <div className="flex flex-col gap-4.5 items-center mt-12">
                        ...
                        <p className="max-w-100 text-center">Transfer your payment all over the world with no payment fee.</p>
                    </div>
                </div>
                <div className="flex-1 flex items-center flex-col text-center ">
                    ...
                    <div className="flex flex-col gap-4.5 items-center mt-12">
                        ...
                        <p className="max-w-100 text-center">The right place to keep your credit and debit cards, boarding passes & more.</p>
                    </div>
                </div>
            </div>
        </section>
